...
ActiveRecord::Schema.define(version: 2021_01_22_130039) do
  ...
  create_table "planner_skills", charset: "utf8mb4", force: :cascade do |t|
  ...
  create_table "planners", charset: "utf8mb4", force: :cascade do |t|
    t.string "name"
    t.string "email"
    t.string "password_digest"
    t.datetime "created_at", precision: 6, null: false
